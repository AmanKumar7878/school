...
<body>
    <div id = "main">
        ...
        <div class="navbar"  id ="nvbr" style="background-color: black; color: aliceblue; font-size: 45px;">
            ...
            <div class="n1">
                <a href="fatchdata.php"> <i class="fa fa-calendar" aria-hidden="true"></i>Students Details</a>
            </div>
        ...
        <div id ="navi">
            ...
            <div class="n">
                <a href="fatchdata.php"> <i class="fa fa-user" aria-hidden="true"></i>Students Details</a>
            </div>
            <div class="n">
                <a href="index.php"><i class="fa fa-user"></i> Log Out</a>
            </div>
        </div>
